        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          >
            <TabsTrigger value="login" 
              // Reduced font size
              className="text-sm"
            >Đăng nhập</TabsTrigger> {/* Reduced font size */}
            <TabsTrigger value="signup" 
              // Reduced font size
              className="text-sm"
            >Đăng ký</TabsTrigger> {/* Reduced font size */}
          </TabsList>
            ...
            <Card>
              <CardHeader className="p-4 pb-2"> {/* Reduced padding */}
                <CardTitle 
                  // Reduced font size
                  className="text-xl"
                >Đăng nhập</CardTitle> {/* Reduced font size */}
                <CardDescription 
                  // Reduced font size
                  className="text-sm"
                >
                ...
                <form onSubmit={handleLogin} className="space-y-3"> {/* Reduced space-y */}
                  ...
                  <div className="space-y-1.5"> {/* Reduced space-y */}
                    <Label htmlFor="login-password" 
                      // Reduced font size
                      className="text-sm"
                    >Mật khẩu</Label> {/* Reduced font size */}
                    <Input
                      id="login-password"
                      type="password"
                      placeholder="••••••••"
            ...
            <Card>
              <CardHeader className="p-4 pb-2"> {/* Reduced padding */}
                <CardTitle 
                  // Reduced font size
                  className="text-xl"
                >Đăng ký</CardTitle> {/* Reduced font size */}
                <CardDescription 
                  // Reduced font size
                  className="text-sm"
                >
                ...
                <form onSubmit={handleSignup} className="space-y-3"> {/* Reduced space-y */}
                  <div className="space-y-1.5"> {/* Reduced space-y */}
                    <Label htmlFor="signup-name" 
                      // Reduced font size
                      className="text-sm"
                    >Họ và tên</Label> {/* Reduced font size */}
                    <Input
                      id="signup-name"
                      type="text"
                  ...
                  <div className="space-y-1.5"> {/* Reduced space-y */}
                    <Label htmlFor="signup-confirm" 
                      // Reduced font size
                      className="text-sm"
                    >Xác nhận mật khẩu</Label> {/* Reduced font size */}
                    <Input
                      id="signup-confirm"
                      type="password"
                      placeholder="••••••••"
